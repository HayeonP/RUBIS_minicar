...
#include "pure_pursuit_param_core.h"
...
{ 
  int32_t p_param_flag = 1;
  double p_const_velocity = 5;
  double p_const_lookahead_distance = 0.2;
  double p_lookahead_distance_ratio = 1;
  double p_minimum_lookahead_distance = 0.2;

  nh_.param("param_flag", p_param_flag);
  nh_.param("const_velocity", p_const_velocity);
  nh_.param("lookahead_distance_ratio", p_lookahead_distance_ratio);
  ...
  minimum_lookahead_distance_ = p_minimum_lookahead_distance;
  is_config_set_ = true;
}

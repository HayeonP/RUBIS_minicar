...
int main(int argc, char** argv)
{
  ...
  // Subscribers
  // ros::Subscriber config_sub = nh.subscribe("config/voxel_grid_filter", 10, config_callback); // # Modified
  private_nh.param("measurement_range", measurement_range, MAX_MEASUREMENT_RANGE); // # Added
  private_nh.param("voxel_leaf_size", voxel_leaf_size, 2.0); // # Added

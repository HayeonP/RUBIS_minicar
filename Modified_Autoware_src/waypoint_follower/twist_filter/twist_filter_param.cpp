...
void configCallback(ros::NodeHandle& nh)
{
  nh.param("lateral_accel_limit", g_lateral_accel_limit);
  nh.param("lowpass_gain_linear_x", g_lowpass_gain_linear_x);
  nh.param("lowpass_gain_angular_z", g_lowpass_gain_angular_z);

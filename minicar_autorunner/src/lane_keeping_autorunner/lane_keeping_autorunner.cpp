...
void LaneKeepingAutorunner::register_subscribers(){
    ...
    sub_v_[STEP(1)] = nh_.subscribe("/ndt_stat", 1, &LaneKeepingAutorunner::ndt_stat_cb, this);
    sub_v_[STEP(2)] = nh_.subscribe("/lane_waypoints_array", 1, &LaneKeepingAutorunner::lane_waypoints_array_cb, this);
    sub_v_[STEP(3)] = nh_.subscribe("/local_trajectories", 1, &LaneKeepingAutorunner::local_trajectories_cb, this);
    //sub_v_[STEP(4)]
    sub_v_[STEP(5)] = nh_.subscribe("/behavior_state", 1, &LaneKeepingAutorunner::behavior_state_cb, this);
    sub_v_[STEP(6)] = nh_.subscribe("/twist_raw", 1, &LaneKeepingAutorunner::twist_raw_cb, this);
    //sub_v_[STEP(7)]
}
